...
int main(){
	...
	switch(decision_1){ //char data type evokes the ASCII table
	...
	*/
	...
	if (decision_1 == 102 || decision_2 == 99){ //conversion (f to c)
		...
		double f_to_c = double((first - 32)*(5.0/9));
		cout << setprecision(1) << fixed << double(f_to_c) << endl;
		
	}
	
	if (decision_1 == 99 || decision_2 != 107 && decision_2 == 102){ //conversion (c to f)
		cout << (double(first*(9.0/5) + 32)) << endl;
		
	}
	
	if (decision_1 == 99 || decision_2 != 102 && decision_2 == 107){
