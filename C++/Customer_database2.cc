...
void setup(Customer &c){ 
   ...
   cout << "Customer City: ";
   //getline(cin, c.city);
   while (c.city.empty()){					//breaks the loop once string IS NOT empty
	...
	while(choice != 4){
		...
		switch(choice){
            case 1:
                ...
                cout << "\nYou have entered information for customer number: " << num_of_customers << endl << endl;
                num_of_customers++;
                break;
            //break;
            case 2:
                ...
                if(id <= num_of_customers && id >= 0){
                	...
                	cout << "\nYou have entered information for customer number: " << id << endl << endl;
				}
                break;
            case 3:
